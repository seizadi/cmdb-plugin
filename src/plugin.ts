...
export const EntityCmdbContent = cmdbPlugin.provide(
  createRoutableExtension({
...
export const EntityLastCmdbAuditCard = cmdbPlugin.provide(
  createComponentExtension({
    component: {
      lazy: () =>
        import('./components/Cards').then(m => m.LastCmdbAuditCard),
    },
  }),
);
